...
class TeamMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_member" do
    assert_difference('TeamMember.count') do
      post team_members_url, params: { team_member: { email: @team_member.email, nome: @team_member.nome, senha: @team_member.senha } }, as: :json
    end
  ...
  test "should update team_member" do
    patch team_member_url(@team_member), params: { team_member: { email: @team_member.email, nome: @team_member.nome, senha: @team_member.senha } }, as: :json
    assert_response 200
  end
