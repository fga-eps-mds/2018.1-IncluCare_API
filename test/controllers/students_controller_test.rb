...
class StudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "shouldn't update student" do
    patch student_url(@student2), params: { student: { address: @student2.address, age: @student2.age, birth_date: @student2.birth_date, father_name: @student2.father_name, mother_name: @student2.mother_name, name: @student2.name, nationality: @student2.nationality, parent_email: @student2.parent_email, parent_telephone: @student2.parent_telephone, shift: @student2.shift, student_class: @student2.student_class, year: @student2.year } }, as: :json
    assert_response :unprocessable_entity
  end
